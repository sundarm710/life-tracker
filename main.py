...
df = fetch_only_expenses_excluding_home_loan()
...
with tab1:
    ...
    st.write("Excluding Home Loan")
    filtered_df = fetch_only_expenses_excluding_home_loan()
    fig_daily_filtered = create_time_chart(filtered_df, 'daily', group_by_option)
...
with tab2:
    ...
    st.write("Excluding Home Loan")
    filtered_df = fetch_only_expenses_excluding_home_loan()
    fig_weekly_filtered = create_time_chart(filtered_df, 'weekly', group_by_option)
...
with tab3:
    ...
    st.write("Excluding Home Loan")
    filtered_df = fetch_only_expenses_excluding_home_loan()
    fig_monthly_filtered = create_time_chart(filtered_df, 'monthly', group_by_option)
